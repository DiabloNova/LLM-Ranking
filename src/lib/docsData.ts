...
- **Migration Artifacts:** \`database/drizzle/\` is the single canonical, journalled migration chain and the only directory the migration runner applies. All \`0001-0020\` SQL scripts under \`database/migrations/\` are frozen historical records; four of them (\`0015\`, \`0017\`, \`0018\`, \`0019\`) were originally applied out-of-band and their effects are now reproduced inside the canonical chain by \`0005_canonical_drift_alignment.sql\`.
`
  },
  {
